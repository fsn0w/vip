...
<div class="relative z-10 bg-prima-white" id="benefits">
    ...
    <div class="container mx-auto">
        ...
        ?>        
            <div class="benefit relative w-[320px] md:w-full max-w-sm bg-prima-gray" x-data="{desc:false}" @click.outside="desc=false">
                ...
                <div class="flex flex-col justify-between group overflow-hidden relative h-full" @click="desc=true" :class="{'cursor-pointer' : !desc}">
                    <div class="flex items-center border-b group-hover:border-prima-black overflow-hidden aspect-square transition-transform duration-500 relative" :class="{'scale-0 opacity-0 !absolute':desc}">
                    ...
                    <div class="p-4 flex flex-col justify-between" :class="{'h-full':desc}">
                        <div class=" transition-all duration-500 py-4" >
