...
?>        
        <div class="benefit relative max-w-sm bg-prima-gray" x-data="{desc:false}">
            <button @click="desc=false" x-show="desc" type="button" class="absolute z-10 top-0 right-0 p-4 group"><svg class="w-4 h-4" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M15.0082 16.6958L27.9028 29.5903C28.0831 29.7706 28.3944 30 28.7548 30C29.1153 30 29.4102 29.7706 29.6068 29.5903C30.1475 29.0497 30.1475 28.4434 29.6068 27.8864L16.7122 14.9918L29.6068 2.09717C30.1475 1.55649 30.1475 0.95026 29.6068 0.393187C29.0661 -0.147501 28.4599 -0.147501 27.9028 0.393187L15.0082 13.2878L2.11365 0.409572C1.91704 0.229342 1.62212 -4.071e-05 1.26166 -4.071e-05C0.901201 -4.071e-05 0.589896 0.229342 0.409666 0.409572C-0.131022 0.966644 -0.131022 1.55649 0.409666 2.11356L13.3043 15.0082L0.409666 27.9027C-0.131022 28.4434 -0.131022 29.0497 0.409666 29.6067C0.950355 30.1474 1.55658 30.1474 2.11365 29.6067L15.0082 16.7121V16.6958Z" fill="#221F20" class="group-hover:fill-prima-red" /></svg></button>
            <div class="flex flex-col justify-between group overflow-hidden relative h-full" @click="desc=true" :class="{'cursor-pointer' : !desc}">
                <div class="border-b group-hover:border-prima-black overflow-hidden aspect-square transition-transform duration-500 relative" :class="{'scale-0':desc}">
