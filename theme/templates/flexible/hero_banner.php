...
<div class="relative md:h-[200vh]">
    ...
    <div class="fixed inset-0 w-full flex flex-wrap items-center text-prima-white font-mono font-medium uppercase bg-prima-red" x-data="{ scroll: false }" @scroll.window="scroll = (window.pageYOffset > 170) ? true : false">
