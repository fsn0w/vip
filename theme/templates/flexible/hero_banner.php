...
<div class="relative md:h-[200vh]">
    ...
    <div class="sticky top-0 flex flex-wrap items-center text-prima-white font-mono font-medium uppercase bg-prima-red" x-data="{ scroll: false }" @scroll.window="scroll = (window.pageYOffset > 130) ? true : false">
