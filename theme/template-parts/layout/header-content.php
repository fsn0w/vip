			...
			?>
				<a href="<?php echo home_url(); ?>" class="group">
					...
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						viewBox="0 0 465.8 92.4" style="enable-background:new 0 0 465.8 92.4;" xml:space="preserve" class="h-16 w-auto">
					<g>
						<g>
							<path class="transition-all duration-300 fill-prima-red group-hover:fill-prima-white" d="M46.6,83.3c-20.4,0-37.1-16.6-37.1-37.1S26.2,9.2,46.6,9.2c20.4,0,37.1,16.6,37.1,37.1
						...
						<g class="transition-all duration-300 group-hover:scale-90 group-hover:translate-x-1 group-hover:translate-y-1">
							<path class="transition-all duration-300 fill-[#F3F3F0] group-hover:fill-prima-red" d="M43.2,39.4c0.2-1.6-0.1-3.1-1.4-3.9c-1.3-0.9-2.9-0.9-4.5-0.2c-0.5,0.2-0.8,0.5-0.4,1
								...
								L43.2,39.4z"/>
							<path class="transition-all duration-300 fill-[#F3F3F0] group-hover:fill-prima-red" d="M45.2,45.2c1.6,0.7,3.9-1.1,4-2.9c0-1-0.5-1.6-1.5-1.7c-1.6,0-3.4,1.8-3.3,3.3
								C44.4,44.5,44.8,45.1,45.2,45.2z"/>
							<path class="transition-all duration-300 fill-[#F3F3F0] group-hover:fill-prima-red" d="M74.7,34.2c-0.5-0.5-1.2-0.9-1.9-1.3c-0.1-0.1-0.2-0.1-0.4-0.2c-0.1-0.1-0.3-0.1-0.4-0.2
